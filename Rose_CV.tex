...
% \textbf{\href{http://network.asa3.org}{American Scientific Affiliation (ASA)}} \hfill \textbf{2014 - present}\\
...
{\bf \href{http://gradphysics.nd.edu/conference/gpsac-2016/}{Graduate Physics Society (GPS) Annual Conference}} \hfill {\bf 2016 }
% \\Member of the Oranizing Committee\\
    \begin{itemize}\itemsep -2pt
    \item[] \textit{\small{Organizing committee member for a conference with over 60 attendees.}} % A total of 16 talks and posters
...
%\href{http://gradphysics.nd.edu/2016/11/30/gpsac-2016-agenda/}{The conference had over 10 posters \\and 6 talks.}
    ...
    % \end{itemize} \vspace{-10pt}   
{\bf \href{gradphysics.nd.edu}{Graduate Physics Society}} \hfill {\bf 2015 - present }
    \begin{itemize}\itemsep -2pt
...
%\\ \textit{\small{I was the Physics Department representative and worked on issues of parking, \\health insurance, building remodels, and more.}}\\
    \begin{itemize}\itemsep -2pt
    \item[] \textit{\small{I was the Physics Department representative and worked on issues of \\parking, health insurance, building remodels, and more.}}
    \end{itemize} \vspace{-12pt}
% {\bf American Physical Society (APS)}, Student Member  \hfill {\bf 2011 - 2014 }\\
...
% We developed and built radiation, ozone, and temperature \\detector systems. \\
    ...
    \item[] \textit{\small{I worked with middle school students on two high altitude balloon experiments, \\ where we developed and built radiation, ozone, and temperature detector \\systems.}}
...
{\bf Proficient:} &  \href{http://jupyter.org}{Jupyter Notebook}, \href{http://pandas.pydata.org}{pandas}, Linux, \href{https://jekyllrb.com}{Jekyll}, HTML, CSS, Windows \\
{\bf Basic Knowledge:} &  C++, Parallel Computing, Mathematica, MATLAB, Javascript%, Apple Script, ROOT, Swift\\
\end{tabular}
...
% \\I taught weekly basic programing help session and graded programing\\ assignments.\\
    \begin{itemize}\itemsep -2pt
    \item[] \textit{\small{Taught basic programing help session and graded assignments.}}
    \end{itemize} \vspace{-12pt}
...
\textbf{Pre-Med. Intro. Physics labs} \hfill{} \textbf{Fall 2012 \&}\\
