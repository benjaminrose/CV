...
% \usepackage[T1]{fontenc}  % this package does not work on TraviCI
...
%%%%%%% relink to a profesional website %%%%%%%%%%%%%%
...
\begin{itemize}\itemsep -2pt
%  \item[] I hope: SIG \hfill {\bf 2020--present}
...
corner.py, 
kde\_corner, sncomso, \href{https://github.com/conda-forge/extinction-feedstock}{extinction}\\
...
% \vspace{-12pt}
% \hangindent=15pt 
% {\bf Rose, B. M.}, Rubin, D., Dixon, S., et al. 2020, {\sl Testing Linear Standardization of Type Ia Supernovae using Gaussian Processes}

% \vspace{-12pt}
% \hangindent=15pt 
% {\bf Rose, B. M.} 2020, {\sl Host Galaxy Corrections are a Red Herring:  Type Ia Supernovae Need Nonlinear Models}
