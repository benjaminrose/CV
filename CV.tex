...
\moveleft.5\hoffset\centerline{\large \bf Physics graduate student at Notre Dame}
...
{\bf 3rd year Ph.D. Student\hfill  {\it started} September 2012 }\\
...
{\bf \hfre{?}{Supplemental Instruction} Leader:} \label{SI}
...
{\bf AAS}, Junior Member  \hfill {\bf 2014 - present }\\
...
{\bf Proficient:} Mathematica, MATLAB, Windows \\
{\bf Basic Knowledge:} C++, ROOT, Linux \\
...
something cool and automatic!
\subsection{First Author}
\subsubsection{Collaborator}
G. Mathews, et. al. (2014) {\it Cosmic Bulk Flow.} in prep.
